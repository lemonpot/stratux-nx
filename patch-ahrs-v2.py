...
# ---------------------------------------------------------------------------
# AHRS V2 UI TEMPORARILY DISABLED. The backend Go code stays active (both
# algorithms run in parallel inside selectableAHRS), but the web UI selector
# and indicators are not injected. AHRSV2_Enabled defaults to false so
# Legacy AHRS is always the published algorithm.
# To re-enable the UI selector, set this flag to True.
# ---------------------------------------------------------------------------
AHRS_V2_UI_VISIBLE = False
...
# ---------------------------------------------------------------------------
# UI SECTIONS: selector, GPS indicators, help text, CSS.
# Skipped when AHRS_V2_UI_VISIBLE is False.
# ---------------------------------------------------------------------------
if AHRS_V2_UI_VISIBLE:

  # ---------------------------------------------------------------------------
  # Settings controller: load selector state and save mode immediately.
  # ---------------------------------------------------------------------------
...
'''
  ...
  # GPS/AHRS page: estimator and confidence indicators.
...
if AHRS_V2_UI_VISIBLE:
    ...
    print("AHRS v2 backend wired (UI selector temporarily hidden, AHRSV2_Enabled defaults to false)")
