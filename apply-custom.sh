...
if command -v gofmt >/dev/null 2>&1; then
  gofmt -w "$TARGET/main/datausage.go" "$TARGET/main/datausage_wire.go" "$TARGET/main/datausage_flows.go" "$TARGET/main/flightlog.go" "$TARGET/main/flightlog_sync.go" "$TARGET/main/ahrs_v2.go"
fi
